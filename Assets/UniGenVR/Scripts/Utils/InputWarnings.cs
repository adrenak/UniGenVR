...
namespace UniGenVR.Utils {
    ...
    public class InputWarnings : MonoBehaviour {
        ...
        [SerializeField] private VRInput VRInput;                                     // Reference to the VRInput to detect input.
        ...
        private void Awake() {
            ...
            m_ScaleMultiplier = m_TextTransform.localScale.x / reticle.ReticleTransform.localScale.x;
        ...
        private IEnumerator SingleClickCheckDelay() {
            ...
            yield return new WaitForSeconds(VRInput.DoubleClickTime);
        ...
        private IEnumerator DisplayWarning(string message) {
            ...
            m_TextTransform.position = reticle.ReticleTransform.position;
            ...
            m_TextTransform.localScale = reticle.ReticleTransform.localScale * m_ScaleMultiplier;
