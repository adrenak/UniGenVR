...
namespace VRStandardAssets.Utils {
    ...
    public class SelectionSlider : MonoBehaviour {
        ...
        [SerializeField] private bool m_RequiresClick;                      // Whether the bar requires click to start filling. False for Gaze based input
        ...
        private void HandleOver() {
            ...
            // If we dont require click, we also call HandleDown to simulate click down
            if (!m_RequiresClick)
                HandleDown();
        }
        ...
        private void HandleOut() {
            ...
            // If we dont require click, we also call HandleDown to simulate click up
            if (!m_RequiresClick)
                HandleDown();
        }
    }
