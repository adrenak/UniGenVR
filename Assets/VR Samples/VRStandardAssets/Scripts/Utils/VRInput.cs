...
namespace UniGenVR {
    ...
    public class VRInput : MonoBehaviour {
        ...
        [SerializeField] private KeyCode m_TriggerButton;
        [SerializeField] private KeyCode m_CancelButton;
        ...
        private void Awake() {
            var allInputs = FindObjectsOfType<VRInput>();
        ...
        private void CheckInput() {
            ...
            if (UnityEngine.Input.GetKeyDown(m_TriggerButton)) {
                // When Fire1 is pressed record the position of the mouse.
                m_MouseDownPosition = new Vector2(UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y);
            ...
            if (UnityEngine.Input.GetKeyUp(m_TriggerButton)) {
                // When Fire1 is released record the position of the mouse.
                m_MouseUpPosition = new Vector2(UnityEngine.Input.mousePosition.x, UnityEngine.Input.mousePosition.y);
            ...
            if (UnityEngine.Input.GetKeyDown(m_CancelButton)) {
                if (OnCancel != null)
                    OnCancel();
            }
        }
