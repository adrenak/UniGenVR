...
namespace UniGenVR {
    ...
    public class Reticle : VRBehaviour {
        ...
        [SerializeField] private GameObject m_ReticleObject;

        private Image m_ReticleImage;                               // Reference to the image component that represents the reticle.
        ...
        private void Awake() {
            m_ReticleImage = m_ReticleObject.GetComponent<Image>();
            m_ReticleTransform = m_ReticleObject.GetComponent<Transform>();
