...
namespace UniGenVR {
    ...
    public class SelectionSlider : VRBehaviour {
        ...
        private ScreenFader m_UIFader;                                      // Optional reference to a UIFader, used if the SelectionSlider needs to fade out.
        ...
        private void Awake() {
            ...
            m_UIFader = GetComponentInParent<ScreenFader>();
        }
        ...
        public IEnumerator WaitForBarToFill() {
            ...
            if (gameObject && m_DisappearOnBarFill)
